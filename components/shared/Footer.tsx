  ...
  return (
    <footer className="w-full border-t border-gray-200 dark:border-gray-800 bg-background">
      <div className="max-w-6xl mx-auto py-16 px-6">
        ...
        {/* On mobile, it's a simple flex column. On desktop, it becomes a relative container. */}
        <div className="relative flex flex-col md:flex-row items-center justify-center gap-8">
          
          {/* Left side: Copyright (Absolutely positioned on desktop) */}
          <div className="order-last md:order-none md:absolute md:left-0">
            <p className="text-sm text-muted-foreground">
              © {new Date().getFullYear()} Keerthi Sree Marrapu
            </p>
          </div>
